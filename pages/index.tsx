        ...
        <form className="flex justify-center mt-10">
          <div className="bg-gray-50 p-8 rounded-lg">
            ...
            <div className="flex space-x-2 p-2 bg-white rounded-md">
              <input value={description} onChange={(evento) => setDescription(evento.currentTarget.value)} type="text" placeholder="Write here..." className="w-full outline-none" />
              <button className="bg-green-500 px-2 py-1 rounded-md text-white font-semibold" onClick={handleClick}>send</button>
            </div>
          </div>
        </form>
        <div>
